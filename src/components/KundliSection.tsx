      ...
      <div style={{ background: '#fdf6ed', borderRadius: 20, padding: '32px 28px', minWidth: 300, maxWidth: 500, flex: 1, boxShadow: '0 20px 60px rgba(0,0,0,0.15)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
          {[
            ...
            ['Birth Place:', 'place', 'text', 'Enter your city or birth place']
            ...
            <div key={key as string} style={{ gridColumn: key === 'place' ? 'span 2' : 'span 1' }}>
              ...
              <input
                ...
                style={{ width: '100%', padding: '9px 0', borderBottom: '1.5px solid #c47a1e', borderTop: 'none', borderLeft: 'none', borderRight: 'none', background: 'transparent', fontSize: 14, fontFamily: 'sans-serif', outline: 'none', color: '#4a2006', boxSizing: 'border-box' }}
              />
            </div>
          ))}
          <div style={{ gridColumn: 'span 2' }}>
            ...
            <select
              ...
              style={{ width: '100%', padding: '9px 0', borderBottom: '1.5px solid #ddc090', borderTop: 'none', borderLeft: 'none', borderRight: 'none', background: 'transparent', fontSize: 14, fontFamily: 'sans-serif', outline: 'none', color: form.gender ? '#4a2006' : '#aaa' }}
            >
