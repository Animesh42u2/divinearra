...
export const consultationsConfig: ConsultationConfig[] = [
  {
    ...
    whatIs: {
      ...
      bullets: [
        'Detailed Personalized Birth Chart (Kundli) Analysis.',
        'In-depth Guidance on Major Life Question.',
    ...
    pricingPlans: [
      {
        ...
        features: [
          ...
          { label: 'Personalized Remedy Suggestion', included: true },
          { label: 'Gemstone & Rudraksha Suggestions', included: true },
          { label: 'Priority Scheduling', included: false },
          { label: '30 Minutes 1-On-1 Session', included: false },
        ],
      },
      {
        name: 'Chanakya',
...

  {
    ...
    pricingPlans: [
      ...
      },
      {
        ...
        highlight: true,
        features: [
          { label: '30-Minutes 1-On-1 Consultation Call', included: true },
          { label: 'Audio Consultation', included: true },
          { label: 'Guna Milan Overview', included: true },
          { label: 'Detailed Dosha Check', included: true },
